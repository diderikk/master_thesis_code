...
// func handleAddNetworkPolicy(objs *counterObjects, podMap *PodMap, namespaceMap *NamespaceMap) func(networkpolicy NetworkPolicy) {
...
// func handleDeleteNetworkPolicy(objs *counterObjects, podMap *PodMap, namespaceMap *NamespaceMap) func(networkPolicy NetworkPolicy) {
// 	return func(networkPolicy NetworkPolicy) {
// 		applicablePods := getPodIpsFromMatchLabel(podMap, networkPolicy.MatchLabel)
...
// func handleUpdateNetworkPolicy(objs *counterObjects, podMap *PodMap, namespaceMap *NamespaceMap) func(oldNetworkPolicy NetworkPolicy, newNetworkPolicy NetworkPolicy) {
...
// func handleAddPod(objs *counterObjects, podMap *PodMap, namespaceMap *NamespaceMap, networkPolicyMap *NetworkPolicyMap) func(podIp uint32, matchLabels map[string]string) {
...
// func handleDeletePod(objs *counterObjects, podMap *PodMap, namespaceMap *NamespaceMap, networkPolicyMap *NetworkPolicyMap) func(podIp uint32, matchLabels map[string]string) {
// 	return func(podIp uint32, matchLabels map[string]string) {
...
// func constructEbpfNetworkPolicies(podMap *PodMap, namespaceMap *NamespaceMap, networkPolicy NetworkPolicy, applicablePods []uint32) ([]counterKey, []uint32) {
...
// 	constructedPoliciyKeys := make([]counterKey, 0)
...
// 			denyKeys := make([]counterKey, len(applicablePods))
...
// 			acceptKeys := make([]counterKey, len(applicablePods)*len(allowedEgressPods))
...
// 			acceptKeys := make([]counterKey, len(applicablePods)*len(allowedIngressPods))
...
// 			// Append all pods that intersect PodSelector labels and NamespaceSelector labels
